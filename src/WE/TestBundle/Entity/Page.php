...
class Page
{
    ...
    {
        $this->pagesData = new ArrayCollection();
    }
     ...
     * Add pagesData
     *
     * @param \WE\TestBundle\Entity\PageData $pagesData
     *
     * @return Page
     */
    public function addPagesData(\WE\TestBundle\Entity\PageData $pageDatas)
    {
        $this->pageDatas[] = $pageDatas;
        
        $pageDatas->setPage($this);
     ...
     * @param \WE\TestBundle\Entity\PageData $pagesData
     */
    public function removePageDatas(\WE\TestBundle\Entity\PageData $pageDatas)
    {
        $this->pageDatas->removeElement($pageDatas);
    }
